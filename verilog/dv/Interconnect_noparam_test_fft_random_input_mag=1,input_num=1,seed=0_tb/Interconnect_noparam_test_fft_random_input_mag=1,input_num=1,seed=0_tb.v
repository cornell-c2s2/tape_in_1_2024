...
module Interconnect_noparam_tb;
  ...
  spiflash #(
      .FILENAME("Interconnect_noparam_tb.hex")
  ) spiflash (
      .csb(flash_csb),
      .clk(flash_clk),
      .io0(flash_io0),
  ...
  assign io_out[4:0] = mprj_io[15:11];
  ...
  initial begin
    $dumpfile("Interconnect_noparam_tb.vcd");
    $dumpvars(0, Interconnect_noparam_tb);
    #1;
...
`endif
  ...
  task t(
    ...
    integer lineno
      ...
      `CHECK(lineno, io_out, ref_io_out, "io_out (io_out in Verilog)");
      ...
      #(`CYCLE_TIME-`INTRA_CYCLE_TIME);
      `CHECK(lineno, miso, ref_adapter_parity, "failing test");
      #(`CYCLE_TIME-`INTRA_CYCLE_TIME);
  ...
  initial begin
    ...
    // Start test
    `include "Interconnect_noparam_test_fft_random_input_mag=1,input_num=1,seed=0_tb.v.cases"
